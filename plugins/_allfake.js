...
handler.all = async function (m) {
	...
	try {
		...
		global.kontak2 = [
         [owner[0], await this.getName(owner[0] + '@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'yuzu.officialdesu@gmail.com', true],
         [owner[1], await this.getName(owner[1] + '@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'takinadesuwa@gmail.com', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: { // Bagian ini sesuka kalian berkreasi :'v
					...
					sourceUrl: "https://github.com/RaffGremory",					
				}
			}
		}
//----------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  //          mediaUrl: "https://Instagram.com/raff.gremory",
   //         mediaType: "VIDEO",
   //         description: "https://Instagram.com/raff.gremory", 
   //         title: 'Takina Ft. Yuzu',
   //         body: wm,
   //         thumbnailUrl: pp,
    //        sourceUrl: sgc
//    }
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------
            ...
            message: { "liveLocationMessage": { "caption":"by : Takina","h": `${wm}`, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
//----------------------------------------------------------------------------------------------------------------------------------------------------------------               
                  global.fliveLoc2 = {
            key:
            ...
            participant: `0@s.whatsapp.net`, ...(m.chat ? 
            { remoteJid: "status@broadcast" } : {}) },
            message: { "liveLocationMessage": { "title": "Takina","h": wm, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
//----------------------------------------------------------------------------------------------------------------------------------------------------------------               
                   global.ftoko = {
       key: {
